...
Route::middleware(['auth:sanctum', 'verified'])->get('/settings', [UserController::class, 'index'])->name('settings.index');
Route::middleware(['auth:sanctum', 'verified'])->put('/settings', [UserController::class, 'update'])->name('settings.update');
