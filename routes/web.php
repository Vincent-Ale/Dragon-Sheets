...
Route::get('/', function () {
    ...
    Route::put('/characters/show/{character}/update-lore', [CharacterController::class, 'updateLore'])
    ->name('characters.updateLore');

    Route::put('/characters/show/{character}/update-notepad', [CharacterController::class, 'updateNotepad'])
    ->name('characters.updateNotepad');
